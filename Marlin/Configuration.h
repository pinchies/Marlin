...
#define STRING_CONFIG_H_AUTHOR "Pinchies" // Original author or contributor.
...
#define CUSTOM_MACHINE_NAME "Artist-D Pro"
...
#define HOTEND_OFFSET_X { 0.0, -2.0 } // (mm) relative X-offset for each nozzle
#define HOTEND_OFFSET_Y { 0.0, 0.1 }  // (mm) relative Y-offset for each nozzle
...
//#define LIMITED_MAX_FR_EDITING        // Limit edit via M203 or LCD to DEFAULT_MAX_FEEDRATE * 2
  ...
  #define MAX_FEEDRATE_EDIT_VALUES    { 600, 600, 10, 100, 100 } // ...or, set your own edit limits
#endif
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 3000, 3000, 100, 6000 , 6000 }
